...
%% Run
callback_outputs = MOGA (fobj,is_maximization_or_minization,nVar,lb,ub,Pops_num,Num_Chr,MaxIt,Archive_size,alpha,nGrid,beta,gamma,f_callbacks);
